...
sap.ui.define(['jquery.sap.global', 'sap/m/Button', 'sap/m/Dialog', 'sap/m/Text', 'sap/m/FormattedText', 'sap/m/Link', 'sap/m/VBox', 'sap/ui/core/IconPool', 'sap/ui/core/ElementMetadata', 'sap/ui/core/library', 'sap/ui/core/Control', 'sap/m/library'],
			...
			(function () {
				...
				MessageBox.error = function (vMessage, mOptions) {
					...
					mOptions = jQuery.extend({}, mDefaults, mOptions);
                        ...
                        var oTextArea = new Text("textBox", { text: vMessage });  
                        oTextArea.addStyleClass("TextDimension");
                    
                    

					return MessageBox.show(oTextArea, mOptions);
				};
