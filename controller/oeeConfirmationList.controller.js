sap.ui.define(
    ...
    function (
        ...
        var interval;
        var that;
        return Controller.extend("customActivity.controller.oeeConfirmationList", {
            formatter: formatter,
            ...
            onPressConf: function () {
                ...
                for (var i = 0; i < tableUnfilteredData.length; i++) {
                    if (tableUnfilteredData[i].STATUS == "FAILED") {
            ...
            onClickGetConsumption: function (oEvent) {
                ...
                if (!oDialog) {
                    oDialog = sap.ui.xmlfragment(
                        oView.getId(),
                        "customActivity.fragmentView.consumptionBatchList",
                        this
                    );
            ...
            getConsumptionQry: function (entryID) {
                ...
                var tRunner = new TransactionRunner(
                    "MES/UI/ConfirmationList/getConsumptionBatchQry",
                    params
                );
