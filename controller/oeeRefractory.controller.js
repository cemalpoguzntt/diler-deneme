  ...
  function (
    ...
    return Controller.extend("customActivity.controller.oeeRefractory", {
      ...
      */
      getRefractoryDetail: function (castNo) {
        ...
        if (oData[0].Row) {
          ...
          var selectedRow = oData[0].Row[0];
          //var equipmentCounter = oData[0].Row[0].EQUIPMENT_COUNTER;
          //var equipmentBaseCounter = oData[0].Row[0].EQUIPMENT_BASE_COUNTER;

          this.getView().byId("idEquipmentCounter").setValue(selectedRow.EQUIPMENT_COUNTER);
          this.getView().byId("idEquipmentBaseCounter").setValue(selectedRow.EQUIPMENT_BASE_COUNTER);
          this.getView().byId("idEquipmentNumber").setSelectedKey(selectedRow.EQUIPMENT_NO);
          this.getView().byId("idUsegeStatus").setSelectedKey(selectedRow.USAGE_STATUS);
          this.getView().byId("idEquipmentBase").setSelectedKey(selectedRow.EQUIPMENT_BASE);
          this.getView().byId("idCompany").setSelectedKey(selectedRow.USAGE_STATUS);
          this.getView().byId("idPersonnel").setSelectedKey(selectedRow.PERNR);
      ...
      callLastCounters: function (p_this, p_data) {
        ...
        if (p_data.Rowsets.Rowset[0].Row) {
          if (p_data.Rowsets.Rowset[0].Row[0].USAGE_STATUS == "10") {
            //devam statüsü
            ...
            //ıskarta statüsü
            p_this.getView().byId("idEquipmentCounter").setValue("1");
            var equipmentBaseCounter = p_data.Rowsets.Rowset[0].Row[0].EQUIPMENT_BASE_COUNTER + 1;
            p_this.getView().byId("idEquipmentBaseCounter").setValue(equipmentBaseCounter);
          }
        }
          ...
          p_this.getView().byId("idEquipmentCounter").setValue("1");
          p_this.getView().byId("idEquipmentBaseCounter").setValue("1");
        }
      ...
      */
      ...
      changeEquipmentNo: function () {

        var equipmentNumber = this.getView().byId("idEquipmentNumber").getSelectedKey();

        var params = { I_PLANT: this.appData.plant, I_CAST_NO: this.screenObj.castNo, I_EQUIPMENT_NO: equipmentNumber};
        var tRunner = new TransactionRunner(
          "MES/UI/Refractory/changeEquipmentXqry",
          params
        );
        //tRunner.ExecuteQueryAsync(this, this.callRefractoryDetail);
        ...
        if (oData[0].Row) {
          var equipmentCounter = oData[0].Row[0].EQUIPMENT_COUNTER;
          this.getView().byId("idEquipmentCounter").setValue(equipmentCounter);
        }
        else {
          this.getView().byId("idEquipmentCounter").setValue("1");
        }
      ...
      changeEquipmentBase: function () {

        var equipmentBaseNumber = this.getView().byId("idEquipmentBase").getSelectedKey();

        var params = { I_PLANT: this.appData.plant, I_CAST_NO: this.screenObj.castNo, I_EQUIPMENT_BASE: equipmentBaseNumber};
        var tRunner = new TransactionRunner(
          "MES/UI/Refractory/changeEquipmentBaseXqry",
          params
        );
        //tRunner.ExecuteQueryAsync(this, this.callRefractoryDetail);
        ...
        if (oData[0].Row) {
          var equipmentCounter = oData[0].Row[0].EQUIPMENT_COUNTER;
          this.getView().byId("idEquipmentBaseCounter").setValue(equipmentCounter);
        }
        else {
          this.getView().byId("idEquipmentBaseCounter").setValue("1");
        }
