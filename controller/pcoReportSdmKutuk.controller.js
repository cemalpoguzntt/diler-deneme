sap.ui.define(
  ...
  function (
    ...
    "use strict";
    return Controller.extend("customActivity.controller.pcoReportSdmKutuk", {
      onInit: function () {
     ...
     this.getCastNoList();
      ...
      getCastNoList: function () {
        var plant = this.appData.plant;       
         TransactionCaller.async(
          "MES/Itelli/CELIKHANE/PCO_REPORT/T_GETCASTNUMBER",
          {
            I_PLANT: plant,
      ...
      getTableData: function () {
        TransactionCaller.async(
          "MES/Itelli/CELIKHANE/PCO_REPORT/T_GETTABLEDATA",
          {
