sap.ui.define(
    ...
    function (
        ...
        var pastRunId;
        return Controller.extend("customActivity/controller/oeeReportQuantityPCW", {
            ...
            handleAddConfirm: function (oEvent) {
                ...
                var selectRow = 0;
                var oModel_productionQuantityModel = new sap.ui.model.json.JSONModel();
                var idInputMiktar = this.byId("reportProductionQuantityTable").mAggregations.items[0].mAggregations.cells[1].sId;
                ...
                if (objek == "3007DUMMY_MC" || objek == "3007PCSTRAND") {
                    ...
                    this.getView().byId(idInputMiktar).setValue(this.appData.allCharacteristic.Y_METRAJ.VALUE);
                }
            ...
            onSavePcStrand: function (oEvent) {
                ...
                if (isSavePcStrand) {
                    ...
                    if (!!DateTimePicker) {
                     ...
                     //  PCW Şifreli Hurda Girişi
                     var params = {
                        "Param.1": "PCW_REP_QNT_HURDA_PSW",
                    };
                    ...
                    var oData = tRunner.GetJSONData();
                    var PCW_REP_QNT_HURDA_PSW = Number(oData[0].Row[0].VALUE);


                    //  PCW Hurda Girişi
                    var params2 = {
                        "Param.1": "PCW_REP_QNT_HURDA",
                    };
                    ...
                    var PCW_REP_QNT_HURDA = Number(oData2[0].Row[0].VALUE);

                    if (oData[0].checkBox && scrapQuantity > PCW_REP_QNT_HURDA_PSW) {

                        //  PCW Hurda Girişi Şifresi
                        var params = {
                            "Param.1": "PCW_REP_QNT_HURDA_ENTRY_PSW",
                        };
                        var tRunner = new TransactionRunner("MES/Itelli/DNA/AdminPanel/selectModelbyKeyQry", params);
                        if (!tRunner.Execute()) {
                            MessageBox.error(tRunner.GetErrorMessage());
                        ...
                        var adminPassword = prompt(PCW_REP_QNT_HURDA_PSW + " kg üstünde hurda girişi yapmak için şifre gereklidir.")
                    ...
                    } else if (!oData[0].checkBox && scrapQuantity < PCW_REP_QNT_HURDA) {
            ...
            onSavePcStrand2: function (oEvent) {
                ...
                var meterage = this.byId("reportProductionQuantityTable").mAggregations.items[0].mAggregations.cells[1].getValue();


                if (matnr != "PC_WIRE_CBK") {
                    this.screenObj.inputChar.push({
                        CHAR_NAME: "Y_METRAJ",
                        CHAR_VALUE: meterage,
                    });
                ...
                if (objek == "3007PCWIRE") {
                    this.screenObj.inputChar.push({
                        ...
                        CHAR_VALUE: (currentWeight + 10) / 1000,
                    });
                }
                /*
                ...
                */
                ...
                var y_kgm = (parseFloat(idWeight.getValue()) / parseFloat(meterage)).toFixed(6);
                ...
                if (oData[0].checkBox) {
                    var params = {
                        ...
                        "Param.2": plant,
                        "Param.3": aprio,
                        "Param.4": matnr == "PC_WIRE_CBK" ? 216 : 217,
                    };
                    var tRunner = new TransactionRunner(
                        "MES/UI/ReportQuantity/getDispoMatnrQry",
                        params
                ...
                if (objek == "3007PCWIRE") {
                    var response = TransactionCaller.sync(
                        "MES/UI/ReportQuantity/getPcWireCastNoTrns",
                        {
                            I_SCT_BATCH: oData[0].BARCODE,
                            I_CONS_WEIGHT: currentWeight,
                            I_CURRENT_WEIGHT: selectedWeight,
                        },
                        "O_JSON"
                    );
                    if (response[1] == "E") {
