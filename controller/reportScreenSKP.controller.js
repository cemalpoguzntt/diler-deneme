sap.ui.define(
    ...
    function (
        ...
        return Controller.extend(
            "customActivity.controller.reportScreenSKP",

            {
                ...
                searchData: function () {
                    ...
                    var response = TransactionCaller.sync(
                        "MES/Itelli/DNA/DNAReport/SKINPASS/T_SKP_ReportScreen",
                    ...
                    this.getView().byId("SKPReport").setModel(tableModel);
                ...
                onExport: function (oEvent) {
                    ...
                    var tableModel = this.getView().byId("SKPReport").getModel();
                    if (!(!!tableModel?.oData)) {
