sap.ui.define(
    ...
    function (
        ...
        var state = true;
        var selectedItem;
        return Controller.extend("customActivity.controller.oeeConfirmationListDNA", {
            formatter: formatter,
            ...
            checkWorkCenter: function () {
                var workCenter = this.appData.node.description;
                    if (workCenter.includes("Örme")) {
                        this.getView().byId("idColMC").setVisible(true);
                    }
            },
            checkShift: function () {
