    ...
    function (
      ...
      return Controller.extend("customActivity.controller.oeeBilletConsumption", {
        ...
        onInit: function () {
          ...
          var input_filter1 = day;
          var input_filter2 = window.location.href.split("&")[2]?.split("=")[1];
          var input_filter3 = window.location.href.split("&")[3]?.split("=")[1];
          var input_filter4 = window.location.href.split("&")[4]?.split("=")[1];
          var input_filter5 = window.location.href.split("&")[5]?.split("=")[1];

          if(input_filter1 != "" || input_filter2 != "" || input_filter3 != "" || input_filter4 != "" || input_filter5 != "") {
            this.getView().byId("idDatePicker").setValue(input_filter1);
            this.getView().byId("selectShift").setSelectedKey(input_filter2); 
            this.getView().byId("selectARBPL").setSelectedKey(input_filter3);
            this.getView().byId("inputsipNo").setValue(input_filter4);
            this.getView().byId("inputDNo").setValue(input_filter5);  
        ...
        onConfirmBilletYield: function () {
          sap.m.MessageBox.warning(
            this.appComponent.oBundle.getText(
              "Teyit vermek istediğinize emin misiniz?"
            ),
            {
              actions: [
                this.appComponent.oBundle.getText("EVET"),
        ...
        onClickOpenBilletFragment: function (oEvent) {
          var selectedRowContext = oEvent
            ...
            .split("/")[1];
          var confirmBilletYield =
            this.getView().getModel("confirmBilletYield").oData;
        ...
        onClickChangeBilletFragment: function (oEvent) {
          ...
          var obj = {
            ...
            //Kaan 03.02.2022
            WERKS : this.appData.plant,
            DATE : this.getView().byId("idDatePicker").getValue(),
            NEWYOL: oEvent.oSource.oParent.getCells()[1].getText(),
            NEWSHIFT: oEvent.oSource.oParent.getCells()[0].getText(),
            NEWORDER: oEvent.oSource.oParent.getCells()[2].getText(),
            NEWCASTID: oEvent.oSource.oParent.getCells()[3].getText(),
            NEWKTKCNT: this.appData.node.workcenterID,
            NEWHB: oEvent.oSource.oParent.getCells()[14].getText(),
            NEWUB: oEvent.oSource.oParent.getCells()[13].getText(),
            NEWSHORT: oEvent.oSource.oParent.getCells()[15].getText(),
          };
          var oModel = new sap.ui.model.json.JSONModel();
          oModel.setData(obj);
        ...
        handleCancel: function (oEvent) {
          this.getView()
            .byId(oEvent.getSource()?.oParent.sId.split("--")[1])
            .destroy(); //.close();
        },
        ...
        onChangeDialogShortPiece: function (oEvent) {
          ...
          tRunner.ExecuteQueryAsync(
            this,
            this.callInsertZmpmBilletShiftShortPieceXquery
          );
        },
        ...
        onPressYieldReport: function (oEvent) {
          ...
          //   activityId:"ZACT_YIELDREPORT_SCR"
          // }),
          this.input_filter1 = this.getView().byId("idDatePicker").getValue();
          this.input_filter2 = this.getView().byId("selectShift").getSelectedKey();
          this.input_filter3 = this.getView().byId("selectARBPL").getSelectedKey();
          this.input_filter4 = this.getView().byId("inputsipNo").getValue();
          this.input_filter5 = this.getView().byId("inputDNo").getValue();
          ...
          location.href = window.location.origin + "/OEEDashboard/WorkerUI.jsp?client=100&plant=" + plant + "#/activity/ZACT_YIELDREPORT_SCR";
        },
        ...
        onPressChangeBilletYield: function (oEvent) {
          ...
          var input = {
            ...
            SELECTED: this.getView().byId("idRB1").getSelected(),
            WERKS : this.appData.plant,
            DATE : this.getView().byId("idDatePicker").getValue(),
        ...
        getTableFilter: function (oEvent) {
            ...
            var werks = this.appData.plant;
            var dateS = this.getView().byId("idDatePicker").getValue();
            var session = this.getView().byId("idSessionSelect").getSelectedKey().split("-");
            if (session[0] == "") {
                session[0] = "00:00:00";
                session[1] = "24:00:00";
            }
