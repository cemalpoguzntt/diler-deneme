sap.ui.define(
  ...
  function (
    ...
    "use strict";
    return Controller.extend("customActivity.controller.pcoDevrilmeAO", {
      onInit: function () {
     ...
     this.getCastNoList();
      ...
      getCastNoList: function () {
        var plant = this.appData.plant;       
         TransactionCaller.async(
          "MES/Itelli/CELIKHANE/PCO_REPORT/AO_DEVRILME/T_GETCASTNUMBER",
          {
            I_PLANT: plant,
      ...
      getTableData: function () {
        TransactionCaller.async(
          "MES/Itelli/CELIKHANE/PCO_REPORT/AO_DEVRILME/T_GETTABLEDATA",
          {
            I_ENDDATE: moment(this.byId("idDateRangeSelection").getValue().split(' - ')[1],'YYYY-MM-DD').add('days',1).format('YYYY-MM-DD') ,
            I_STARTDATE: this.byId("idDateRangeSelection").getValue().split(' - ')[0],
      ...
      callGetTableData: function (iv_data, iv_scope) {
        ...
        myArrr.forEach((element) => {
          element.REC_ID = JSON.stringify(element.REC_ID);
