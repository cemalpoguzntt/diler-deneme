sap.ui.define(
    ...
    function (
        ...
        return Controller.extend("customActivity.controller.oeeOperatorDashboardStandardDeliveredActivityCharcForPanelSd", {
            ...
            */
            ...
            createViewsAndAddToLayout: function () {
                this.orderCardView = sap.ui.view({
                    viewName: "customActivity.view.orderCardCharcTileSd", type: sap.ui.core.mvc.ViewType.XML,
                    width: "100%",
