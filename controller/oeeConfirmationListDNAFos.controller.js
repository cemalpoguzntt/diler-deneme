sap.ui.define(
    ...
    function (
        ...
        var state = true;
        var selectedItem;
        return Controller.extend("customActivity.controller.oeeConfirmationListDNAFos", {
            formatter: formatter,
            ...
            getData: function () {
                if (!!!this.getView().byId("filterSearch").getValue()) {
                    state = true;
                }
                else {
                    state = false;
                ...
                var tRunner = new TransactionRunner(
                    "MES/UI/ConfirmationList/getConfirmationListQryDNA",
                    params
                );
                if (!tRunner.Execute()) {
            ...
            retryConfirmation: function (oEvent) {
                ...
                var response99 = TransactionCaller.sync(
                    "MES/Itelli/PastActivity/T_GunuKapatControl",
                    {
                        I_CLIENT: this.appData.client,
                        I_PLANT: this.appData.plant,
                        I_WORKPLACE: oData99[0].Row[0].NAME,
                        I_DATE: data.START_DATE,   // seçili teyitin tarihi                       
                
                    },
                    "O_JSON"
                );
                if (response99[1] == "E") {
                    MessageBox.error("Gün kapatılmıştır teyit iptal edilemez.");
                    return;
                }
            ...
            onAcceptCncCnf: function () {
                ...
                */
                var responseCancel = TransactionCaller.sync(
                    "MES/UI/ConfirmationList/confirmCancelDNATrns",
                    {
                        I_CONF_NUMBER: data.CONF_NUMBER,
                        I_CONF_COUNTER: data.CONF_COUNTER,
                        I_ENTRYID: data.ENTRY_ID,
            ...
            */
            ...
            getDataByPartiNo: function () {
                var batchno = this.getView().byId("partiSearch").getValue();
                ...
                var tRunner = new TransactionRunner(
                    "MES/UI/ConfirmationList/getConfirmationListQryDNAFOS",
                    params
                );
                if (!tRunner.Execute()) {
                    //var oData = tRunner.GetJSONData();
            ...
            onClear: function () {
                ...
                this.getView().byId("partiSearch").setValue("");
